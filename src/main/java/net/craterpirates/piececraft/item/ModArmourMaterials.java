...
public enum ModArmourMaterials implements ArmorMaterial {
    SEASTONE("seastone", 30, new int[]{7, 9, 6, 5}, 45,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 2f, 2f, () -> Ingredient.of(ModItems.SEASTONE_INGOT.get()));
    ...
    public String getName() {
        return PieceCraft.MOD_ID+":"+this.name;
    }
