...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.SEASTONE_HELMET);
        trimmedArmorItem(ModItems.SEASTONE_CHESTPLATE);
        trimmedArmorItem(ModItems.SEASTONE_LEGGINGS);
        trimmedArmorItem(ModItems.SEASTONE_BOOTS);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject){
        final String MOD_ID = PieceCraft.MOD_ID;
